...
const Intro = () => {
  return (
    <section id='intro' className='relative flex items-center justify-between h-[100dvh] gap-5 mobile:justify-center'>
